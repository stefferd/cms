{* Smarty *}
    <div class="form">
    <form action="{$SCRIPT_NAME|replace:'index.php':''}teams/update/{$teams->getId()}/" method="post">
        {if $error ne '' }
                ...
                <div class="block settings">
                    ...
                    <div class="field">
                        ...
                        {if $teams->getPicture() ne ''}
                            <div class="answer"><img src="{$SCRIPT_NAME|replace:'index.php':''}{$teams->getPicture()}" border="0" title="Teamfoto" /></div>
                        {else}
